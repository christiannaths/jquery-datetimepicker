...
$.extend($.ui, { datetimepicker: { version: "1.8" } });
...
$.extend(Datetimepicker.prototype, {
	...
	_newInst: function(target, inline) {
		...
		return {id: id, input: target, // associated target
			...
			$('<div class="' + this._inlineClass + ' ui-datetimepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'))};
	},
	...
	_showDatetimepicker: function(input) {
		...
		if (!inst.inline) {
			...
			var postProcess = function() {
				...
				inst.dpDiv.find('iframe.ui-datetimepicker-cover'). // IE6- only
	...
	_updateDatetimepicker: function(inst) {
		...
		inst.dpDiv.empty().append(this._generateHTML(inst))
			.find('iframe.ui-datetimepicker-cover') // IE6- only
				.css({left: -borders[0], top: -borders[1],
					width: inst.dpDiv.outerWidth(), height: inst.dpDiv.outerHeight()})
			.end()
			.find('button, .ui-datetimepicker-prev, .ui-datetimepicker-next, .ui-datetimepicker-calendar td a')
		...
		// add time sliders	
		generateHourPicker();
		generateMinutePicker();
		generateMeridianPicker();	
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			'<a class="ui-datetimepicker-prev ui-corner-all" onclick="DP_jQuery_' + dpuuid +
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			'<a class="ui-datetimepicker-next ui-corner-all" onclick="DP_jQuery_' + dpuuid +
			'.datetimepicker._adjustDate(\'#' + inst.id + '\', +' + stepMonths + ', \'M\');"' +
		...
		var controls = (!inst.inline ? '<button type="button" class="ui-datetimepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_' + dpuuid +
			'.datetimepicker._hideDatetimepicker();">' + this._get(inst, 'closeText') + '</button>' : '');
		var buttonPanel = (showButtonPanel) ? '<div class="ui-datetimepicker-buttonpane ui-widget-content">' + (isRTL ? controls : '') +
			(this._isInRange(inst, gotoDate) ? '<button type="button" class="ui-datetimepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_' + dpuuid +
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !changeMonth)
			...
			monthHtml += '<select class="ui-datetimepicker-month" ' +
		...
		if (secondary || !changeYear)
			...
			html += '<select class="ui-datetimepicker-year" ' +
